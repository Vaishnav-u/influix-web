            ...
            <div ref={shellRef} className="relative z-[1] group">
                ...
                >
                    ...
                    >
                        ...
                        >
                            <img
                                className="w-full absolute left-1/2 bottom-[-140px] backface-hidden will-change-transform transition-transform duration-[120ms] ease-out"
                                src={avatarUrl}
                            ...
                            <div className="w-full absolute flex flex-col" style={{ top: '3em', display: 'flex', gridArea: 'auto' }}>
                                <h3
                                    ...
                                    style={{
                                        ...
                                        backgroundImage: 'linear-gradient(to bottom, #fdf9dfff, #ffcc00ff)',
